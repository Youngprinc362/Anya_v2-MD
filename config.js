...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "Young Prince",
    ownernumber: process.env.Owner_Number || "263780858655",
    ...
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/FWbBB26iQlz5GzFgzXBtN1",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "mongodb+srv://youngprinc362:mukudzei2022@cluster0.5z6nl.mongodb.net/?retryWrites=true&w=majority",
    sessionId: process.env.SESSION_ID || "anpyNDV_Queen-Anya_3Z3c=",
